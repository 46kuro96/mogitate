...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $param = [
            ...
            'image' => 'fruits-img 2/strawberry.png',
        ];
        DB::table('products')->insert($param);
        $param = [
            'name' => 'オレンジ',
        ...
        $param = [
            ...
            'image' => 'fruits-img 2/watermelon.png',
        ];
        DB::table('products')->insert($param);
        $param = [
            'name' => 'ピーチ',
        ...
        $param = [
            ...
            'image' => 'fruits-img 2/pineapple.png',
        ];
        DB::table('products')->insert($param);
        $param = [
            'name' => 'ブドウ',
